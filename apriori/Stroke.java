...
public class Stroke {
	...
	public Stroke(String id, String gender, String age, int hypertension, int heart_disease, String ever_married,
	...
	public String toString() {
		return "Stroke [id=" + id + ", gender=" + gender + ", age=" + age + ", hypertension=" + hypertension
